...
?>
          <p class="centered"><img  class="img-circle" width="100" src="pics/<?php  echo $row1['Images']; ?>" ></p>
        ...
        <div class="row mt">
          <div class="col-lg-12">				
					...
					$conn=new mysqli("sql101.epizy.com","epiz_31861744","VOHE4jF7ZCG","epiz_31861744_urbanclassics");
						$id=$_GET['id'];
						$query='SELECT *  FROM new_arrivals1  WHERE id='.$id;
						$result=mysqli_query($conn,$query);
					$row=mysqli_fetch_array($result);
					?>
				
						  <form id="styling" class="form-horizontal" action="updatecourses.php" method="post" >
							<div class="form-group">
							  <label><h4>Course Name:</h4></label>
							  <input type="text" class="form-control"   name="stock_name" value="<?php echo $row['stock_name'] ?>" >
							  <input type="hidden" name="id" value="<?php echo $id; ?>">
							</div>
							<div class="form-group">
							  <label  for="Desc"><h4>Description:</h4></label>
							  <textarea  class="form-control"   name="price_tag" ><?php echo $row['price_tag'];?></textarea>
							</div>
							<div class="form-group">
							...
							<br>
							<button style="" type="submit" class="btn btn-info" name="submit">Update</button>
						  </form>
						  </div>
