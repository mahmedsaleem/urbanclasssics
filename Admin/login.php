      ...
      <form class="form-login" action="checklogin.php" method="POST">
        ...
        <div class="login-wrap">
          ...
          <label class="checkbox">
            ...
            <a data-toggle="modal" href="login.php"> Forgot Password?</a>
            </span>
            </label>
          <button class="btn btn-theme btn-block" href="index.php" type="submit" name="submit"><i class="fa fa-lock"></i> SIGN IN</button>
          <hr>
