...
<!-- Mirrored from affixtheme.com/html/xmee/demo/register-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2020 15:15:08 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="fxt-form">
                                <form action="userdata.php" method="POST">
                                    ...
                                    <div class="form-group">  
                                        ...
                                        <input id="c_password" type="password" class="form-control" name="cpassword" placeholder="********" required="required">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="sumit" class="fxt-btn-fill">Register</button>
                                    </div>
                                </form>                            
                            </div> 
                            <div class="text-center">
                                <p>Have an account?<a href="login-4.php" class="switcher-text">Log in</a></p>
                            </div>                            
                        </div>
                    </div>
                </div>
